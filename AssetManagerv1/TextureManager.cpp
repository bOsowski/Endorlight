...
std::map<std::string, std::pair<int, std::shared_ptr<sf::Texture>>> TextureManager::m_textures;
...
{
#if TARGET_OS_MAC
    //Only required for OSX. Removes unused directory - easier fix, create folder references and use resources folder
   // eraseSubStr(filePath,"../");
