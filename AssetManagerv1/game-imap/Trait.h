...
namespace GameIMap {
    ...
    public:
        ...
        inline virtual Vector2 getLocation(InterestMap *_interest, LayerMapCollection *const _collection, int _centerX, int _centerY, int _radius, int _id) {
            return Vector2::zero();
        }
        ...
        inline virtual Vector3 getWorldLocation(Vector2 _location, int _centerX, int _centerY, InterestMap *_interest, InfluenceMap *_influence, float _cellSize, float _z) {
            return Vector3::zero();
        }
